...
class _SubscriptionCheckoutScreenState
  ...
  Future<void> orderRequest(BuildContext context) async {
    ...
    try {
      ...
      arguments['goodsType'] = '2';
      arguments['goodsName'] = 'Member';
      arguments['goodsCode'] = 'V001';
      arguments['goodsCnt'] = '1';
      arguments['orderAmount'] = '5';
      arguments['orderDescription'] = 'Subscription Member';

      await _subscriptionServices
          .createSubcriptionOrder(arguments)
          .then((response) async {
